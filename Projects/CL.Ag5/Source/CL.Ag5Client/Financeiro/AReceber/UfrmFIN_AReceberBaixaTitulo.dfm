inherited frmFIN_AReceberBaixaTitulo: TfrmFIN_AReceberBaixaTitulo
  Tag = -99
  Left = 616
  Top = 154
  ...
  inherited _pnlForm: TJvPanel
    ...
    inherited _pnlDetail: TJvPanel
      ...
      object GroupBox2: TGroupBox
        ...
        object dblcCC: TDBLookupComboBox
          Left = 126
          Top = 14
          Width = 319
          Height = 21
        ...
        object edtRecebido: TJvDBCalcEdit
          Left = 350
          Top = 71
          Width = 96
          Height = 21
        ...
        object dbcbCheque: TDBCheckBox
          ...
          Width = 169
          Height = 17
          Caption = 'Recebimento com cheque No.'
          DataField = 'CHEQUE'
          DataSource = dtsFicha
          TabOrder = 5
          ValueChecked = 'T'
      ...
      object GroupBox3: TGroupBox
        ...
        Height = 66
        Align = alBottom
        Caption = 'Observa'#231#245'es da parcela'
        TabOrder = 2
        ExplicitTop = 434
    ...
    inherited _pnlFooter: TJvPanel
      ...
      object btbEstornar: TTcGDIButton
        Left = 11
        Top = 3
        Width = 97
        Height = 29
  ...
  object dtsFicha: TDataSource [1]
    DataSet = dtmFIN_AReceberBaixaTitulo.cdsAReceberParcela
    Left = 304
    Top = 2
  end
  ...
  object dtsApropriacao: TDataSource
    DataSet = dtmFIN_AReceberBaixaTitulo.cdsApropriacaoJuroDesconto
    Left = 370
    Top = 10
  end
end
