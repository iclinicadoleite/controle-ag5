inherited FIN_OutrasReceitasWizard: TFIN_OutrasReceitasWizard
  Left = 413
  Top = 204
  Caption = 'Vendas - Lan'#231'amentos Simplificados'
  ClientHeight = 712
  ClientWidth = 896
  ActionList.Left = 264
  ActionList.Top = 2
  ...
  inherited _pageControl: TPageControl
    ...
    inherited _tbsLista: TTabSheet
      ...
      inherited _pnlSearch: TPanel
        ...
        object chkContasRecebidas: TCheckBox
          Left = 530
          Top = 41
          Width = 137
          Height = 17
          Hint = 'Exibe contas recebidas no per'#237'odo'
          TabStop = False
          Caption = 'Exibir contas recebidas'
          ...
          TabOrder = 1
          Visible = False
          OnClick = chkContasRecebidasClick
        end
      ...
      inherited _pnlFicha: TPanel
        ...
        inherited _ScrollBoxFicha: TScrollBox
          ...
          inherited _pnlScroll: TPanel
            ...
            object dbcbProvisao: TDBCheckBox
              Left = 682
              Top = 108
              Width = 97
              Height = 17
            ...
            object gbxProgramarParcelas: TGroupBox
              ...
              object lblTipoValorReceita: TLabel
                Left = 7
                Top = 21
                Width = 98
                Height = 13
              ...
              object dbValorReceita: TJvDBCalcEdit
                Left = 119
                Top = 19
                Width = 98
                Height = 21
  ...
  inherited ActionList: TInternalActionList
    ...
    object actDecrementaAno: TAction
      Category = 'Navigate'
      Hint = 'Ano Anterior'
      OnExecute = actDecrementaAnoExecute
    end
  ...
  inherited dtsFicha: TDataSource
    DataSet = FIN_OutrasReceitasDatamodule.cdsAReceber
    OnDataChange = dtsFichaDataChange
    Left = 463
    Top = 2
  end
  inherited dtsLista: TDataSource
    DataSet = FIN_OutrasReceitasDatamodule.cdsLstAReceber
    Left = 422
    Top = 2
  end
  ...
  object dtsParcelas: TDataSource
    DataSet = FIN_OutrasReceitasDatamodule.cdsParcelas
    Left = 535
    Top = 2
  end
