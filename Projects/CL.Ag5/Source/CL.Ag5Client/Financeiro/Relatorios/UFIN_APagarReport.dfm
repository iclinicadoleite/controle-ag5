inherited FIN_APagarReport: TFIN_APagarReport
  Left = 591
  Top = 110
  Caption = 'FIN_APagarReport'
  ClientHeight = 774
  ClientWidth = 844
  ExplicitWidth = 860
  ExplicitHeight = 813
  ...
  object cdsFIN_APAGAR2: TClientDataSet
    Aggregates = <>
    Params = <
      item
    ...
    Left = 236
    Top = 16
    object cdsFIN_APAGAR2KFIN_APAGAR: TStringField
      FieldName = 'KFIN_APAGAR'
      Required = True
    end
    object cdsFIN_APAGAR2HISTORICO: TStringField
      FieldName = 'HISTORICO'
      Required = True
      Size = 60
    end
    object cdsFIN_APAGAR2NOMEENTIDADE: TStringField
      FieldName = 'NOMEENTIDADE'
      Size = 128
    end
    object cdsFIN_APAGAR2DATALANCTO: TSQLTimeStampField
      FieldName = 'DATALANCTO'
      Required = True
    end
    object cdsFIN_APAGAR2DOCUMENTO: TStringField
      FieldName = 'DOCUMENTO'
    end
    object cdsFIN_APAGAR2KFIN_APAGAR_PARCELA: TStringField
      FieldName = 'KFIN_APAGAR_PARCELA'
      Required = True
    end
    object cdsFIN_APAGAR2PARCELAS: TStringField
      DisplayLabel = 'Parcelas'
      FieldName = 'PARCELAS'
      Size = 23
    end
    object cdsFIN_APAGAR2VENCTO: TSQLTimeStampField
      FieldName = 'VENCTO'
      Required = True
    end
    object cdsFIN_APAGAR2VALOR: TFloatField
      FieldName = 'VALOR'
      Required = True
      DisplayFormat = '#,0.00'
    end
    object cdsFIN_APAGAR2PREVISAO: TStringField
      FieldName = 'PREVISAO'
      Required = True
      FixedChar = True
      Size = 1
    end
    object cdsFIN_APAGAR2CONTAS: TStringField
      FieldName = 'CONTA'
      Size = 30
    end
  end
  object dspFIN_APAGAR2: TDataSetProvider
    DataSet = sqlFIN_APAGAR2
    Options = [poIncFieldProps]
    UpdateMode = upWhereKeyOnly
    Left = 176
    Top = 56
  end
  object sqlFIN_APAGAR2: TTcSQLDataSet
    SchemaName = 'sysdba'
    MaxBlobSize = -1
    Params = <
      item
    ...
    Left = 236
    Top = 88
    object sqlFIN_APAGAR2KFIN_APAGAR: TStringField
      FieldName = 'KFIN_APAGAR'
      Required = True
    end
    object sqlFIN_APAGAR2HISTORICO: TStringField
      FieldName = 'HISTORICO'
      Size = 128
    end
    object sqlFIN_APAGAR2NOMEENTIDADE: TStringField
      FieldName = 'NOMEENTIDADE'
      Size = 128
    end
    object sqlFIN_APAGAR2DATALANCTO: TSQLTimeStampField
      FieldName = 'DATALANCTO'
      Required = True
    end
    object sqlFIN_APAGAR2DOCUMENTO: TStringField
      FieldName = 'DOCUMENTO'
      Size = 32
    end
    object sqlFIN_APAGAR2KFIN_APAGAR_PARCELA: TStringField
      FieldName = 'KFIN_APAGAR_PARCELA'
      Required = True
    end
    object sqlFIN_APAGAR2PARCELAS: TStringField
      DisplayLabel = 'Parcelas'
      FieldName = 'PARCELAS'
      Size = 23
    end
    object sqlFIN_APAGAR2VENCTO: TSQLTimeStampField
      FieldName = 'VENCTO'
      Required = True
    end
    object sqlFIN_APAGAR2VALOR: TFloatField
      FieldName = 'VALOR'
      Required = True
    end
    object sqlFIN_APAGAR2PREVISAO: TStringField
      FieldName = 'PREVISAO'
      Required = True
      FixedChar = True
      Size = 1
    end
    object sqlFIN_APAGAR2CONTA: TStringField
      FieldName = 'CONTA'
      Size = 64
    end
  end
