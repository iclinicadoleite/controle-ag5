object dtmCAD_Entidades: TdtmCAD_Entidades
  OldCreateOrder = True
  Height = 289
  Width = 900
  ...
  object cdsEntidade: TClientDataSet
    ...
    object cdsEntidadeKSYSLICENSE: TStringField
      FieldName = 'KSYS$LICENSE'
      Required = True
      FixedChar = True
    end
    ...
    object cdsEntidadeCPF_CNPJ: TStringField
      CustomConstraint = 'CPF_CNPJ <> '#39#39
      ConstraintErrorMessage = 'O Campo '#39'CPF / CNPJ'#39' deve ser preenchido'
  ...
  object scRdmCadEntidades: TSharedConnection
    ChildName = 'rdmCAD_Entidades'
    Left = 40
    Top = 200
  end
  ...
  object sqlEntidade: TTcSQLDataSet
    ...
    object sqlEntidadeKSYSLICENSE: TStringField
      FieldName = 'KSYS$LICENSE'
      Required = True
      FixedChar = True
    end
