inherited frmCAD_Clientes: TfrmCAD_Clientes
  Left = 360
  Top = 70
      ...
      inherited _pnlFicha: TPanel
        ...
        inherited _ScrollBoxFicha: TScrollBox
          ...
          inherited _pnlScroll: TPanel
            ...
            object dbeFantasiaApelido: TDBEdit
              Left = 100
              Top = 70
              Width = 250
              Height = 21
            ...
            object edGrupoCliente: TJvDBComboEdit
              Left = 100
              Top = 133
              Width = 250
              Height = 21
              ...
              ButtonWidth = 15
              TabOrder = 9
              OnButtonClick = edGrupoClienteButtonClick
              OnKeyPress = edGrupoClienteKeyPress
            end
  ...
  inherited ActionList: TInternalActionList
    Left = 120
    Top = 1
    object actPrintListFicha: TAction
      Category = 'Print'
      Caption = 'Imprimir Ficha'
      OnExecute = actPrintListFichaExecute
    end
    object actListaCompleta: TAction
      Category = 'Print'
      Caption = 'Lista Completa'
      OnExecute = actListaCompletaExecute
    end
    object actPorGrupo: TAction
      Category = 'Print'
      Caption = 'Por grupo'
      OnExecute = actPorGrupoExecute
    end
  end
  inherited dtsFicha: TDataSource
    DataSet = dtmCAD_Clientes.cdsEntidade
  ...
  inherited _popMenuPrint: TPopupMenu
    ...
    object ImprimirListanovo1: TMenuItem
      Action = actPrintListFicha
    end
    object ListaCompleta1: TMenuItem
      Action = actListaCompleta
    end
    object N2: TMenuItem
      Caption = '-'
    end
  ...
  object dtsEndereco: TDataSource
    DataSet = dtmCAD_Clientes.cdsEndereco
    Left = 467
    Top = 51
  end
  object dtsEnderecoCobranca: TDataSource
    DataSet = dtmCAD_Clientes.cdsEnderecoCobranca
    Left = 553
    Top = 55
  end
  object dtsEnderecoEntrega: TDataSource
    DataSet = dtmCAD_Clientes.cdsEnderecoEntrega
    Left = 665
    Top = 47
  end
  object dtsOutrosEnderecos: TDataSource
    DataSet = dtmCAD_Clientes.cdsOutrosEnderecos
    Left = 662
    Top = 3
  end
  object dtsContatos: TDataSource
    DataSet = dtmCAD_Clientes.cdsContatos
    Left = 744
    Top = 3
  end
  object dtsDadosFinanceiro: TDataSource
    DataSet = dtmCAD_Clientes.cdsDadosFinanceiro
    Left = 676
    Top = 119
  end
end
