inherited Zoo_CfgExamesForm: TZoo_CfgExamesForm
  Left = 294
  Top = 202
  Caption = 'Exames'
  PixelsPerInch = 96
    ...
    inherited _tbsLista: TTabSheet
      inherited _pnlSearch: TPanel
        ...
        object CheckBox1: TCheckBox
          ...
          Width = 165
          Height = 17
          Caption = 'Exibir exames inativos'
          TabOrder = 1
  ...
  inherited dtsFicha: TDataSource
    DataSet = Zoo_CfgExamesDatamodule.cdsExame
    OnStateChange = dtsFichaStateChange
  end
  inherited dtsLista: TDataSource
    AutoEdit = True
    DataSet = Zoo_CfgExamesDatamodule.cdsLstExames
  end
  object dtsItens: TDataSource
    DataSet = Zoo_CfgExamesDatamodule.cdsItens
    Left = 633
    Top = 25
  end
  object dtsResultados: TDataSource
    DataSet = Zoo_CfgExamesDatamodule.cdsResultados
    Left = 696
    Top = 25
  end
end
