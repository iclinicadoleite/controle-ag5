inherited Zoo_AutomacaoExamesWizard: TZoo_AutomacaoExamesWizard
  Left = 321
  Top = 240
  Caption = 'Automa'#231#227'o de Resultados de Exames'
  ClientHeight = 442
  ClientWidth = 701
  Color = clWhite
  ExplicitWidth = 707
        ...
        object TabSheet1: TTabSheet
          ...
          object Panel4: TPanel
            ...
            object Label2: TLabel
              ...
              Height = 13
              Caption = 
                'Altera'#231#245'es na automa'#231#227'o de resultados de exames s'#227'o salvas autom' +
                'aticamente.'
          ...
          object Panel5: TPanel
            ...
            object dblcListaExames: TDBLookupComboBox
              Left = 380
              Top = 4
              Width = 252
              Height = 21
              KeyField = 'KZOO_TAREFA'
              ListField = 'EXAME'
              ListSource = dtsListaExames
              TabOrder = 0
            end
            object dblcResultados: TDBLookupComboBox
              Left = 380
              Top = 27
              Width = 252
              Height = 21
  ...
  object dtsListaExames: TDataSource
    DataSet = Zoo_AutomacaoExamesDatamodule.cdsListaExames
    OnDataChange = dtsListaExamesDataChange
    Left = 446
    Top = 8
  end
  object dtsResultados: TDataSource
    DataSet = Zoo_AutomacaoExamesDatamodule.cdsLstResultados
    OnDataChange = dtsResultadosDataChange
    Left = 558
    Top = 10
  end
end
