unit UZoo_AtividadesLVListagemGeralDatamodule2;
...
type
  ...
  private
    ...
    procedure AnimaisAReexaminar ;
    procedure AnimaisCobertosAMaisDe ;
    procedure AnimaisRecemParidos ;
    procedure AnimaisSemCioCobertura ;
    procedure ClicosAnormais ;
    procedure NovilhasNaoPrenhesAMeses ;
...
begin
  ...
  DBResources['ZOOTECNICO'].populateClientDataSet( cds, _SELECT_INTERVALO, p ) ;
...
begin
  //AnimaisAReexaminar ;
  AnimaisCobertosAMaisDe ;
  AnimaisRecemParidos ;
  AnimaisSemCioCobertura ;
  ClicosAnormais ;
  NovilhasNaoPrenhesAMeses ;
...
procedure TZoo_AtividadesLVListagemGeralDatamodule.AnimaisAReexaminar ;
const
  _SELECT_ANIMAIS_REEXAMINAR =
           ' AF.KZOO_ANIMAL, '
    +#13#10' AF.BRINCO,'
    +#13#10' AF.BRINCO_,'
...
begin
  ...
  DBResources['ZOOTECNICO'].populateClientDataSet( cds, _SELECT_ANIMAIS_REEXAMINAR, p ) ;
...
procedure TZoo_AtividadesLVListagemGeralDatamodule.AnimaisCobertosAMaisDe ;
const
  _SELECT_ANIMAIS_COBERTOS_SEM_CONFIRMACAO =
           ' AF.KZOO_ANIMAL, '
    +#13#10' AF.BRINCO,'
    +#13#10' AF.BRINCO_,'
    +#13#10' AF.NOMEESTABULO,'
    ...
    +#13#10'    || CASE EZ.QTDE_DIAGNOSTICO'
    +#13#10'         WHEN 0 THEN '' dias sem confirmação de prenhez'''
    +#13#10'         WHEN 1 THEN '' dias sem 1ª reconfirmação de prenhez'''
    +#13#10'         WHEN 2 THEN '' dias sem 2ª reconfirmação de prenhez'''
    +#13#10'        END'
    +#13#10' ) PROBLEMA,'
    +#13#10' IIF( DAF.ULTIMA_LACTACAO IS NOT NULL, DAF.ULTIMA_LACTACAO, NULL ) ULTIMO_PARTO,'
    +#13#10' IIF( DAF.ULTIMA_LACTACAO < DAF.ULTIMA_MONTA, DAF.ULTIMA_MONTA, NULL ) ULTIMA_COBERTURA,'
...
//    +#13#10'         AND ( EZ.DATATOQUE IS NULL )'
    +#13#10'         AND ( EZ.PRENHEZ IS DISTINCT FROM ''F'' )'
    ...
    +#13#10'  AND ( DATEADD('
    +#13#10'          (CASE EZ.QTDE_DIAGNOSTICO'
    +#13#10'           WHEN 0 THEN IIF ( DAF.NUMERO_LACTACAO > 1'
    +#13#10'                         , CAST ( :DIAS_CONFIRMAR_MULTIPARA AS INTEGER )'
    +#13#10'                         , CAST ( :DIAS_CONFIRMAR_PRIMIPARA AS INTEGER )    )'
    +#13#10'           WHEN 1 THEN IIF ( DAF.NUMERO_LACTACAO > 1'
    +#13#10'                         , CAST ( :DIAS_CONFIRMAR_MULTIPARA_1X AS INTEGER )'
    +#13#10'                         , CAST ( :DIAS_CONFIRMAR_PRIMIPARA_1X AS INTEGER ) )'
    +#13#10'           WHEN 2 THEN IIF ( DAF.NUMERO_LACTACAO > 1'
    +#13#10'                         , CAST ( :DIAS_CONFIRMAR_MULTIPARA_2X AS INTEGER )'
    +#13#10'                         , CAST ( :DIAS_CONFIRMAR_PRIMIPARA_2X AS INTEGER ) )'
    +#13#10'           END'
    +#13#10'          ) DAY TO (   EZ.DATAEVENTO'
    +#13#10'                     - IIF( EZ.TIPOEVENTO = :EMBRIAO, 7, 0)'
    +#13#10'                   )'
    +#13#10'        ) <= :DATA'
    +#13#10'      )'  ;
...
var
  ...
  p : TParams ;
  DiasPrimimipara,   DiasMultipara : integer  ;
  DiasPrimimipara1X, DiasMultipara1X : integer  ;
  DiasPrimimipara2X, DiasMultipara2X : integer  ;
begin
  // Animais coberto a mais de X dias sem confirmacao de prenhez
  TParamMatriz.GetParam   (
       LoggedUser.DomainID
     , _ST_PARAM_MATRIZES_DIAS_CONFIRMAR_PRENHEZ
     , DiasPrimimipara
     ,   DiasMultipara
  ) ;
  TParamMatriz.GetParam   (
      LoggedUser.DomainID
    , _ST_PARAM_MATRIZES_DIAS_RECONFIRMAR_PRENHEZ_1VEZ
    , DiasPrimimipara1X
    , DiasMultipara1X
  ) ;
  TParamMatriz.GetParam   (
      LoggedUser.DomainID
    , _ST_PARAM_MATRIZES_DIAS_RECONFIRMAR_PRENHEZ_2VEZ
    , DiasPrimimipara2X
    , DiasMultipara2X
  ) ;
  ...
  p.CreateParam( ftString,    'KCAD_FAZENDA',                ptInput ).asString       := LoggedUser.DomainID ;
  p.CreateParam( ftInteger,   'DESCARTADA',                  ptInput ).AsInteger      := _ST_STATUS_FEMEA_DESCARTADO ;
  p.CreateParam( ftInteger,   'DIAS_CONFIRMAR_MULTIPARA',    ptInput ).AsInteger      := DiasPrimimipara   ;
  p.CreateParam( ftInteger,   'DIAS_CONFIRMAR_PRIMIPARA',    ptInput ).AsInteger      := DiasMultipara     ;
  p.CreateParam( ftInteger,   'DIAS_CONFIRMAR_MULTIPARA_1X', ptInput ).AsInteger      := DiasPrimimipara1X ;
  p.CreateParam( ftInteger,   'DIAS_CONFIRMAR_PRIMIPARA_1X', ptInput ).AsInteger      := DiasMultipara1X   ;
  p.CreateParam( ftInteger,   'DIAS_CONFIRMAR_MULTIPARA_2X', ptInput ).AsInteger      := DiasPrimimipara2X ;
  p.CreateParam( ftInteger,   'DIAS_CONFIRMAR_PRIMIPARA_2X', ptInput ).AsInteger      := DiasMultipara2X   ;
  p.CreateParam( ftInteger,   'EMBRIAO',                     ptInput ).AsInteger      := _ST_TIPO_EVENTO_ZOO_IMPLANTE ;
  p.CreateParam( ftTimeStamp, 'DATA',                        ptInput ).AsSQLTimeStamp := DateTimeToSQLTimeStamp(EndOfTheDay(FAte)) ;

  DBResources['ZOOTECNICO'].populateClientDataSet( cds, _SELECT_ANIMAIS_COBERTOS_SEM_CONFIRMACAO, p ) ;
...
procedure TZoo_AtividadesLVListagemGeralDatamodule.NovilhasNaoPrenhesAMeses ;
const
  _SELECT_NOVILHAS_NAO_PRENHES =
           '  AF.KZOO_ANIMAL, '
    +#13#10'  AF.BRINCO,'
    +#13#10'  AF.BRINCO_,'
    +#13#10'  AF.NOMEESTABULO,'
...
begin
  ...
  DBResources['ZOOTECNICO'].populateClientDataSet( cds, _SELECT_NOVILHAS_NAO_PRENHES, p ) ;
...
procedure TZoo_AtividadesLVListagemGeralDatamodule.AnimaisRecemParidos ;
const
  _SELECT_ANIMAL_RECEM_PARIDO =
           '  AF.KZOO_ANIMAL, '
    +#13#10'  AF.BRINCO,'
    +#13#10'  AF.BRINCO_,'
    +#13#10'  AF.NOMEESTABULO,'
...
begin
  ...
  DBResources['ZOOTECNICO'].populateClientDataSet( cds, _SELECT_ANIMAL_RECEM_PARIDO, p ) ;
...
procedure TZoo_AtividadesLVListagemGeralDatamodule.AnimaisSemCioCobertura ;
const
  _SELECT_ANIMAIS_SEM_CIO_COBERTURA =
...
begin
  ...
  DBResources['ZOOTECNICO'].populateClientDataSet( cds, _SELECT_ANIMAIS_SEM_CIO_COBERTURA, p ) ;
...
procedure TZoo_AtividadesLVListagemGeralDatamodule.ClicosAnormais ;
const
  _SELECT_CICLOS_ANORMAIS =
          'SELECT'
...
begin
  ...
  DBResources['ZOOTECNICO'].populateClientDataSet( cds, _SELECT_CICLOS_ANORMAIS, p ) ;
