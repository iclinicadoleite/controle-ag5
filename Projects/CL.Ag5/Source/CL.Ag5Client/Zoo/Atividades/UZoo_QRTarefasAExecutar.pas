...
type
  TZoo_QRTarefasAExecutar = class(TfqrSYS_BaseReport)
    QRLabel1: TQRLabel;
    QRLabel2: TQRLabel;
    QRLabel3: TQRLabel;
    QRLabel4: TQRLabel;
...
constructor TZoo_QRTarefasAExecutar.Create(AOwner: TComponent);
begin
   inherited ;
   Zoo_AtividadesTarefasDatamodule := TZoo_AtividadesTarefasDatamodule.Create ( self ) ;
end;

class procedure TZoo_QRTarefasAExecutar.PrintAte(ADateTime : TDateTime  ; AOrder : TPrinterOrder ; APageBreak : boolean ; APrinterName : string ; APreview : boolean ) ;
var
