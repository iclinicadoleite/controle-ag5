inherited InclusaoMachoWizard: TInclusaoMachoWizard
  Left = 378
  Top = 247
  Caption = 'Inclus'#227'o de macho/semem'
  ClientHeight = 445
  ClientWidth = 693
  ExplicitWidth = 699
  ExplicitHeight = 474
  ...
  object dtsLista: TDataSource
    AutoEdit = False
    DataSet = Zoo_BancoDadosMachoDatamodule.cdsLstMachos
    Left = 539
    Top = 24
  end
  object dtsFicha: TDataSource
    DataSet = Zoo_BancoDadosMachoDatamodule.cdsAnimal
    Left = 579
    Top = 24
  end
