unit UfrmZoo_OcorrenciasAnimal2;

interface

uses
  WinApi.Windows, WinApi.Messages, System.SysUtils, System.Variants, System.Classes, VCL.Graphics, VCL.Controls, VCL.Forms,
  UdtmZoo_OcorrenciasAnimal2,
  SysForms, VCL.ActnList, Data.DB, Tc.Data.DB.Helpers,
  ...
  Tc.VCL.Application,
  Wrappers, System.Actions ;

type
  TfrmZoo_OcorrenciasAnimal = class(T_Form, ITcDataForm)
...
uses   SysTypes,
       ...
       UZoo_SanidadeDiagnosticosWizard,
...
begin
   ...
   NotificationService.SubscribeStr( NeedRefresh,
                                 [ 'EVT_SANIDADE',
                                   ...
                                   'PROCESS_TZoo_SanidadeBaixarTarefasWizard'
                                 ] ) ;
...
procedure TfrmZoo_OcorrenciasAnimal.NeedRefresh(Sender: TObject);
begin
...
begin
  ...
  dbgOcorrenciasCronologica.EditorMode := False ;
  dbgOcorrenciasCronologica.CloseControl ;
  NotificationService.NotifyStr( self, 'SAVE_' + ClassName );
end;
