inherited Zoo_ImportaPesoAlturaWizard: TZoo_ImportaPesoAlturaWizard
  Left = 533
  Top = 312
  ActionList.Left = 452
  PixelsPerInch = 96
  ...
  object JvSaveDialog1: TJvSaveDialog
    DefaultExt = '.xlsx'
    FileName = 'Modelo Peso Altura.xlsx'
    Filter = 'Modelo peso altura.xlsx|*.xlsx'
    Options = [ofOverwritePrompt, ofHideReadOnly, ofEnableSizing]
    Title = 'Salvar modelo peso altura'
