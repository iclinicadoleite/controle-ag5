unit UZoo_ReproducaoFIVDatamodule;
...
type
  TZoo_ReproducaoFIVDatamodule = class(T_dtmBASE)
...
procedure TZoo_ReproducaoFIVDatamodule.cdsColetaEmbriaoBeforeOpen(DataSet: TDataSet);
begin
  inherited;
  SetParams ;
end;

procedure TZoo_ReproducaoFIVDatamodule.cdsColetaEmbriaoBeforePost(DataSet: TDataSet);
begin
...
procedure TZoo_ReproducaoFIVDatamodule.cdsColetaEmbriaoDATAABORTOPARTOValidate(
  Sender: TField);
begin
...
procedure TZoo_ReproducaoFIVDatamodule.cdsColetaEmbriaoEMBRIOESCOLETADOSValidate(
  Sender: TField);
begin
...
procedure TZoo_ReproducaoFIVDatamodule.cdsColetaEmbriaoNOMEFUNCIONARIO_COLETAGetText(
  Sender: TField; var Text: string; DisplayText: Boolean);
begin
  Text := cdsColetaEmbriaoNOMEFUNCIONARIO_COLETA.asString ;
end;

procedure TZoo_ReproducaoFIVDatamodule.cdsColetaEmbriaoNOMEFUNCIONARIO_COLETASetText(
...
constructor TZoo_ReproducaoFIVDatamodule.Create(AOwner: TComponent);
begin
  inherited;
  FGrauDeSangue := TZoo_GrauDeSangue.Create ;
end;

destructor TZoo_ReproducaoFIVDatamodule.Destroy;
begin
  FGrauDeSangue.free ;
  inherited;
end;

procedure TZoo_ReproducaoFIVDatamodule.dtsColetaEmbriaoDataChange(
...
procedure TZoo_ReproducaoFIVDatamodule.dspColetaEmbriaoBeforeUpdateRecord(
  Sender: TObject; SourceDS: TDataSet; DeltaDS: TCustomClientDataSet;
  UpdateKind: TUpdateKind; var Applied: Boolean);


  procedure GetPaiMae ( AKZOO_EVENTO_ZOOTECNICO : string ; out AKZooPai, ABrincoPai, ANomePai, AKZooMae, ABrincoMae, ANomeMae, ABrincoEmbriao, ANomeEmbriao : string ) ;
  var
    cds : TClientDataSet ;
    p : TParams ;
  ...
  var
     sql : TSQLQuery ;
     BrincoEmbriao, NomeEmbriao, tmpAKZooPai, tmpABrincoPai, tmpANomePai, tmpAKZooMae, tmpABrincoMae, tmpANomeMae : string ;
  ...
  const
    ...
    _INCLUI_EMBRIAO = 'INSERT INTO ZOO_ANIMAIS_EMBRIAO ( KZOO_ANIMAL_EMBRIAO, QTDEINICIAL_EMBRIAO, QTDE_EMBRIAO  ) VALUES ( :KZOO_ANIMAL, :QTDEINICIAL_EMBRIAO, :QTDE_EMBRIAO )' ;
...
begin
   ...
   if    ( UpdateKind = ukDelete )
      or ( DeltaDS.FieldByName ( 'DATAABORTOPARTO' ).isNull ) then
      exit ;
...
procedure TZoo_ReproducaoFIVDatamodule.OpenTables;
begin
  FNOMEFUNCIONARIO := '' ;
  KCADFUNCIONARIO  := '' ;
...
procedure TZoo_ReproducaoFIVDatamodule.SetDataColeta(const Value: TDateTime);
begin
  FDataColeta := Value;
end;

procedure TZoo_ReproducaoFIVDatamodule.SetFuncionario(AKFuncionario,
...
procedure TZoo_ReproducaoFIVDatamodule.SetFuncionarioPadrao(
...
procedure TZoo_ReproducaoFIVDatamodule.SetParams;
begin
