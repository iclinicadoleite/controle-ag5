...
uses
  ...
  DateSuppl, DateUtils, SysReportTypes, ReportTypes, System.Actions, Vcl.ActnList, Tc.VCL.Application, Tc.Data.SQLExpr ;

type

  TfqrVENDAS_Pedido = class(TfqrSYS_BaseReport)
...
class procedure TfqrVENDAS_Pedido.Preview ( KPedido : integer ; TipoFolha : TTipoFolha ; EmiteLogo : boolean ) ;
var
  fqrVENDAS_Pedido : TfqrVENDAS_Pedido ;
begin
  fqrVENDAS_Pedido := TfqrVENDAS_Pedido.Create ( nil ) ;
  fqrVENDAS_Pedido.Inicializa(  tePreview, KPedido, TipoFolha, EmiteLogo ) ;
  fqrVENDAS_Pedido.free ;
end;

class procedure TfqrVENDAS_Pedido.Print( KPedido : integer ; TipoFolha : TTipoFolha ; EmiteLogo : boolean ) ;
var
  fqrVENDAS_Pedido : TfqrVENDAS_Pedido ;
begin
  fqrVENDAS_Pedido := TfqrVENDAS_Pedido.Create ( nil ) ;
  fqrVENDAS_Pedido.Inicializa(  tePrint, KPedido, TipoFolha, EmiteLogo ) ;
  fqrVENDAS_Pedido.free ;
end;

class procedure TfqrVENDAS_Pedido.SaveToPDF( FileName : string ; KPedido : integer ; TipoFolha : TTipoFolha ; EmiteLogo : boolean ) ;
var
  fqrVENDAS_Pedido : TfqrVENDAS_Pedido ;
begin
  fqrVENDAS_Pedido := TfqrVENDAS_Pedido.Create ( nil ) ;
  fqrVENDAS_Pedido.Inicializa(  tePDF, KPedido, TipoFolha, EmiteLogo ) ;
  fqrVENDAS_Pedido.free ;
end;


procedure TfqrVENDAS_Pedido.ChildBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
...
procedure TfqrVENDAS_Pedido.QRSubDetail3BeforePrint(
...
procedure TfqrVENDAS_Pedido.QRDBText8Print(sender: TObject;
  var Value: String);
var
  Valor : Double ;
begin
...
procedure TfqrVENDAS_Pedido.Inicializa(TipoEmissao : TTipoEmissao ; KPedido: integer;
...
begin
  ...
  if TipoEmissao = tePreview then
    ...
    begin
       QuickRep.Prepare ;
       //fqrVENDAS_Pedido.QuickRep.Print ;
     end ;

end;

procedure TfqrVENDAS_Pedido.ChildBand6BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
...
procedure TfqrVENDAS_Pedido.QRDBText7Print(sender: TObject;
  var Value: String);
begin
  inherited;
...
procedure TfqrVENDAS_Pedido.QRDBText9Print(sender: TObject;
  var Value: String);
var
  Valor : Double ;
begin
...
procedure TfqrVENDAS_Pedido.QRDBText10Print(sender: TObject; var Value: String);
var
  V1, V2 : Double ;
begin
  inherited;
...
procedure TfqrVENDAS_Pedido.ChildBand7BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
...
procedure TfqrVENDAS_Pedido.ChildBand8BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
