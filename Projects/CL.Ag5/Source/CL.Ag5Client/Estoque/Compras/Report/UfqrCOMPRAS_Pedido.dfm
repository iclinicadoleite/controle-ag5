inherited fqrCOMPRAS_Pedido: TfqrCOMPRAS_Pedido
  Left = 218
  Top = 42
  Caption = 'fqrCOMPRAS_Pedido'
  PixelsPerInch = 96
  TextHeight = 13
  inherited QuickRep: TQuickRep
    ...
    object GroupHeaderBand1: TQRBand [8]
      Left = 57
      Top = 257
      Width = 700
      Height = 31
    ...
    object QRSubDetail1: TQRSubDetail [10]
      Left = 57
      Top = 288
      Width = 700
      Height = 16
    ...
    object GroupFooterBand1: TQRBand [11]
      Left = 57
      Top = 326
      Width = 700
      Height = 25
    ...
    object ChildBand4: TQRChildBand [12]
      Left = 57
      Top = 351
      Width = 700
      Height = 20
    ...
    object ChildBand5: TQRChildBand [13]
      Left = 57
      Top = 304
      Width = 700
      Height = 11
    ...
    object QRSubDetail3: TQRSubDetail [14]
      Left = 57
      Top = 371
      Width = 700
      Height = 33
    ...
    object ChildBand6: TQRChildBand [15]
      Left = 57
      Top = 315
      Width = 700
      Height = 11
    ...
    object QRSubDetail2: TQRSubDetail [16]
      Left = 57
      Top = 435
      Width = 700
      Height = 16
    ...
    object GroupFooterBand2: TQRBand [17]
      Left = 57
      Top = 473
      Width = 700
      Height = 25
    ...
    object GroupHeaderBand2: TQRBand [18]
      Left = 57
      Top = 404
      Width = 700
      Height = 31
    ...
    object ChildBand7: TQRChildBand [19]
      Left = 57
      Top = 451
      Width = 700
      Height = 11
    ...
    object ChildBand8: TQRChildBand [20]
      Left = 57
      Top = 462
      Width = 700
      Height = 11
